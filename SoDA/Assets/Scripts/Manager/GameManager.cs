...
using CharacterController = SoDA.InputSystem.CharacterController;
...
{   
    ...
    //Spawned Players
    private List<CharacterController> activePlayerControllers;
    private bool isPaused;
    private CharacterController focusedPlayerController;
    ...
    {
        activePlayerControllers = new List<CharacterController>();

        if(inScenePlayer == true)
        {
            AddPlayerToActivePlayerList(inScenePlayer.GetComponent<CharacterController>());
        }
    ...
    void SpawnPlayers()
    {
        ...
        for(int i = 0; i < numberOfPlayers; i++)
        {
            ...
            AddPlayerToActivePlayerList(spawnedPlayer.GetComponent<CharacterController>());
        }
    }

    void AddPlayerToActivePlayerList(CharacterController newPlayer)
    {
    ...
    public void TogglePauseState(CharacterController newFocusedPlayerController)
    {
    ...
    public List<CharacterController> GetActivePlayerControllers()
    {
        return activePlayerControllers;
    }

    public CharacterController GetFocusedPlayerController()
    {
